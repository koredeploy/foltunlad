        ...
        <div>
          ...
          <div className="grid w-full md:w-[96%] md:mx-auto lg:w-full  grid-cols-2 gap-4 md:gap-10 py-10">
            <div className="flex flex-row gap-2 items-baseline">
              ...
              <div>
                <h3 className="text-lg lg:text-xl md:text-center lg:text-start">Varieties Option</h3>
                <p className="small-text md:w-5/6 md:mx-auto md:text-center lg:text-start lg:w-full">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque
                  eleifend orci consec.
                </p>
              </div>
            </div>
            <div className="flex flex-row gap-2 items-baseline">
              ...
              <div>
                <h3 className="text-lg lg:text-xl md:text-center lg:text-start">Household Needs</h3>
                <p className="small-text md:w-5/6 md:mx-auto md:text-center lg:text-start lg:w-full">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque
                  eleifend orci consec.
                </p>
            ...
            <div className="flex flex-row gap-2 items-baseline pt-4">
              ...
              <div>
                <h3 className="text-lg lg:text-xl md:text-center lg:text-start">Customer Support</h3>
                <p className="small-text md:w-5/6 md:mx-auto md:text-center lg:text-start lg:w-full">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque
                  eleifend orci consec.
                </p>
            ...
            <div className="flex flex-row gap-2 items-baseline pt-4">
              ...
              <div>
                <h3 className="text-lg lg:text-xl md:text-center lg:text-start">Swift Delivery</h3>
                <p className="small-text md:w-5/6 md:mx-auto md:text-center lg:text-start lg:w-full">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque
                  eleifend orci consec.
                </p>
        ...
        <div className="flex gap-4 lg:gap-7 md:gap-6 md:justify-evenly ">
          <div className="flex flex-col gap-4 md:gap-9 lg:gap-7 ">
            <div className="h-40 lg:h-48 bg-gradient-to-r from-green-200 to-green-100 p-3 lg:p-10 text-white-100 rounded-md flex flex-col items-center justify-center">
              <h1 className="text-center lg:text-start text-xl lg:text-2xl">Satisfied CLients</h1>
              <p className="text-center lg:text-start small-text pt-1 text-white-100" >Our Customers</p>
          ...
          <div className="flex flex-col gap-4 md:gap-9 lg:gap-7">
            ...
            <div className="h-40 lg:h-48 bg-gradient-to-r from-orange-200 to-orange-100 p-3 lg:p-10 text-white-100 rounded-md flex flex-col items-center justify-center">
              <h1 className=" text-center lg:text-start text-xl lg:text-2xl">Customer Support</h1>
              <p className="text-center lg:text-start pt-1 text-white-100">Employees</p>
